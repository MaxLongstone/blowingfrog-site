...
export const STAGES = [
  ...
  },
  {
    ...
    hearts: 3, lives: 3,
    lanes: [
      lane(13, ['robotaxi'], { speed: 1.8, gap: 2.75 }), lane(12, ['semi'], { speed: 1.5, gap: 4.25 }),
      lane(11, ['robotaxi', 'foodtruck'], { speed: 1.9, gap: 2.75 }), lane(10, ['drone'], { kind: 'air', speed: 2.2, gap: 3.0, behaviors: ['dive'] }),
      lane(9, ['robotaxi'], { speed: 2.0, gap: 2.5 }), lane(8, ['semi'], { speed: 1.6, gap: 4.0 }),
      safe(7),
      lane(6, ['robotaxi'], { speed: 2.1, gap: 2.5 }), lane(5, ['foodtruck', 'robotaxi'], { speed: 1.7, gap: 3.0 }),
      lane(4, ['drone'], { kind: 'air', speed: 2.4, gap: 2.75, behaviors: ['dive'] }),
      lane(3, ['semi'], { speed: 1.8, gap: 3.75 }), lane(2, ['robotaxi'], { speed: 2.2, gap: 2.38 }),
      lane(1, ['robotaxi'], { speed: 2.3, gap: 2.38 }),
    ],
    pickups: { explosive: ['dynamite', 'mine'], count: 7 },
    attacks: [],
  },
